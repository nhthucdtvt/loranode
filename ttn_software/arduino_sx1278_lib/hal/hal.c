...
#include "../../../lmic-master/src/hal/hal.h"
#include "../../../lmic-master/src/lmic.h"
...
#define PORT_DIO0			gpioPortE	//DIO0 = PB11
#define PIN_DIO0			10
#define PORT_DIO1			gpioPortE	//DIO1 = PC1
#define PIN_DIO1			11
#define PORT_DIO2			gpioPortE	//DIO2 = PC0
#define PIN_DIO2			12
#define PORT_DIO3			gpioPortD	//DIO3 = PA2
#define PIN_DIO3			5
#define PORT_DIO4			gpioPortA	//DIO4 = PA1
#define PIN_DIO4			0
#define PORT_DIO5			gpioPortC	//DIO5 = PA0
#define PIN_DIO5			13
#define USART_USED                USART1
#define USART_LOCATION            USART_ROUTE_LOCATION_LOC1
#define USART_CLK                 cmuClock_USART1
#define PIN_SPI_TX                0			//MOSI = PE10
#define PORT_SPI_TX               gpioPortC
#define PIN_SPI_RX                1			//MISO = PE11
#define PORT_SPI_RX               gpioPortC
#define PIN_SPI_CLK               7			//SCK = PE12
#define PORT_SPI_CLK              gpioPortB
#define PIN_SPI_CS                8			//CSN = PE13
